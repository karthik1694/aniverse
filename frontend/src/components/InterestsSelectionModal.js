...
export default function InterestsSelectionModal({ isOpen, onClose, onComplete }) {
  ...
  return (
    <>
      ...
      >
        <div className="bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#1a1a2e] border-t-2 border-cyan-500/30 rounded-t-3xl shadow-2xl shadow-cyan-500/20 max-w-2xl mx-auto">
          {/* Content */}
          <div className="px-6 pb-6 pt-6 max-h-[85vh] overflow-y-auto">
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400">Help us find your perfect match</p>
                </div>
              </div>
              <button
                onClick={onClose}
            ...
            {/* Genres Section */}
            <div className="mb-5">
              <h3 className="text-white font-semibold mb-3 text-sm">Favorite Genres</h3>
            ...
            {/* Themes Section */}
            <div className="mb-6">
              <h3 className="text-white font-semibold mb-3 text-sm">Favorite Themes</h3>
              <div className="flex flex-wrap gap-2">
                {themes.map((theme) => (
                  <Badge
                    key={theme}
            ...
            {/* Action Button */}
            <div className="sticky bottom-0 bg-gradient-to-t from-[#16213e] via-[#16213e] to-transparent pt-4 pb-2">
              <Button
                onClick={handleContinue}
                disabled={!canContinue}
                className="w-full bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-semibold py-4 rounded-xl shadow-lg shadow-cyan-500/30 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:shadow-none"
              >
