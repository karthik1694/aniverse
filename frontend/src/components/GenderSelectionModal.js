...
export default function GenderSelectionModal({ isOpen, onClose, onGenderSelect }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-gradient-to-br from-[#1a1a2e]/95 via-[#16213e]/95 to-[#0f1419]/95 backdrop-blur-md border border-cyan-500/30 rounded-2xl p-8 max-w-md w-full shadow-2xl shadow-cyan-500/10 relative">
        ...
        <div className="relative z-10">
          ...
          {/* Gender Selection */}
          <div className="mb-8">
            <h3 className="text-white font-semibold mb-4 text-lg">I am:</h3>
          ...
          <div className="mb-8">
            <div className="flex items-start gap-3">
              ...
              />
              <label htmlFor="ageConfirm" className="text-sm text-gray-300 leading-relaxed">
          ...
          <div className="space-y-4">
            <Button
              ...
              className="w-full bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-semibold py-4 rounded-xl shadow-lg hover:shadow-cyan-500/25 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:shadow-none"
            >
              I AGREE, LET'S GO!
            </Button>
